...
func stopConsensusNet(t *testing.T, reactors []*Reactor, eventBuses []*types.EventBus) {
...
func TestReactorValidatorSetChanges(t *testing.T) {
	...
	// ---------------------------------------------------------------------------
	//  Testing changing the voting power of one validator
	...
	// ---------------------------------------------------------------------------
	// Testing adding two validators at once
	...
	// ---------------------------------------------------------------------------
	// Testing removing two validators at once
